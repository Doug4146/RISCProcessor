...
module jr_tb;
    ...
    initial begin
        ...
        // Put the instruction at RAM[0] so the PC naturally fetches it
        DUT.RAM_Unit.memory[0] = 32'h9E000000; 
        
        // Force R12 to hold target jump address (0xFF)
        force DUT.R12_val = 32'h000000FF;
    end
    ...
    always @(*) begin
        ...
        case (Present_state)
            ...
            // Execute: jr R12
            T3: begin Gra = 1; Rout = 1; PCin = 1; end 
        endcase
    end
endmodule