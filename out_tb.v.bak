...
module out_tb;
    ...
    parameter Default = 4'b0000, Reg_load1a = 4'b0001, Reg_load1b = 4'b0010, 
              T0 = 4'b0011, T1 = 4'b0100, T2 = 4'b0101, T3 = 4'b0110;
    ...
    always @(*) begin
        // Full Reset of all Control Signals
        ...
        Mdatain = 32'h00000000; input_unit = 32'h00000000;

        case (Present_state)
            // Preload R7 with DEADBEEF to prove the output port catches it
            Reg_load1a: begin Mdatain = 32'hDEADBEEF; Read = 1; MDRin = 1; end
            Reg_load1b: begin MDRout = 1; Gra = 1; Rin = 1; Mdatain = 32'h03800000; end // Gra/Rin + IR mapping targets R7

            // Instruction Fetch
            T0: begin PCout = 1; MARin = 1; Zin = 1; end // IncPC is handled by ADD inside ALU in full system, simplified here
            T1: begin Zlowout = 1; PCin = 1; Read = 1; MDRin = 1; Mdatain = 32'h03800000; end // '7' in Ra field
            T2: begin MDRout = 1; IRin = 1; end
            
            // Execute out R7
            T3: begin 
                Gra = 1; Rout = 1;  // Decoder turns on R7out
                OutPort_in = 1;     // Output port latches the bus
            end
        endcase
    end
endmodule