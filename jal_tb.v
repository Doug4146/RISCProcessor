...
module jal_tb;
    ...
    initial begin
        ...
        DUT.RAM_Unit.memory[0] = 32'h9A600001; 
        
        // Preload R4 with target jump address (0x80)
        force DUT.R4_val = 32'h00000080;
        
        force DUT.R12_val = 32'h00000000;
        #20 release DUT.R12_val; 
    end
    ...
    always @(*) begin
        ...
        case (Present_state)
            ...
            //  R12 PC + 1 
            T3: begin PCout = 1; Yin = 1; end 
            T4: begin Cout = 1; ADD = 1; Zin = 1; end 
            T5: begin Zlowout = 1; Grb = 1; Rin = 1; end 
            
            // PC R4
            T6: begin Gra = 1; Rout = 1; PCin = 1; end 
        endcase
    end
endmodule