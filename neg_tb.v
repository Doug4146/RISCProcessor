...
module neg_tb;
    ...
    always @(Present_state) begin
        ...
        IncPC = 0; Read = 0; NEG = 0; R4in = 0; R7in = 0; Mdatain = 32'h00000000;
        ...
        case (Present_state)
            ...
            T1: begin Zlowout = 1; PCin = 1; Read = 1; MDRin = 1; Mdatain = 32'h72380000; end
            T2: begin MDRout = 1; IRin = 1; end
            T3: begin R7out = 1; NEG = 1; Zin = 1; end
