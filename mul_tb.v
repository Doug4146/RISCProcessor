...
module mul_tb;
    ...
    parameter Default = 4'b0000, Reg_load1a = 4'b0001, Reg_load1b = 4'b0010, Reg_load2a = 4'b0011,
              ...
              T3 = 4'b1010, T4 = 4'b1011, T4_wait = 4'b1100, T5 = 4'b1101, T6 = 4'b1110;
    ...
    always @(posedge clock) begin 
        case (Present_state)
            ...
            T2 : Present_state = T3; 
            T3 : Present_state = T4; 
            T4 : Present_state = T4_wait;
				T4_wait : if (!MUL_busy) Present_state = T5; else Present_state = T4_wait;
				T5 : Present_state = T6;
        endcase
    end
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T4: begin R1out = 1; MUL_start = 1; end
				T4_wait: begin R1out = 1; MUL = 1; Zin = 1; end
